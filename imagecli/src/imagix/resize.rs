...
fn resize_image(size: u32, src_folder: &mut PathBuf) -> Result<(), ImagixError> {
    ...
    println!("The image file is {:?}", src_folder);
...
mod tests {
    ...
    fn test_single_image_resize() {
        let mut path = PathBuf::from("tmp/images/image1.jpeg");
        let destination_path = PathBuf::from("tmp/images/tmp/image1.jpeg");
    ...
    fn test_multiple_image_resize() {
        ...
        let destination_path2 = PathBuf::from("tmp/images/tmp/image2.jpeg");
        let destination_path1 = PathBuf::from("tmp/images/tmp/image1.jpeg");
